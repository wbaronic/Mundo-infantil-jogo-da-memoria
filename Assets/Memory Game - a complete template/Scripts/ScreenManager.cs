...
public class ScreenManager : MonoBehaviour {
    ...
    //nterstitialAdExample interstitialAd;

    public void changePanel()
    {

        gameObject1[0].SetActive(false);
        gameObject1[1].SetActive(true);
    ...
    public static void StartGameSaved()
    {
        PlayerPrefs.GetInt("fase", 0);
        PlayerPrefs.GetInt("dificuldade", 1);
